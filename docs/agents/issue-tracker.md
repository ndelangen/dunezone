...
- CI never retries. A retry inside a workflow hides a class, so the standing rule is zero retries, decided on the flake map ([#1045](https://github.com/ndelangen/dunezone/issues/1045)).
