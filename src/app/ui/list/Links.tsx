 ...
 *
 * Callers own the collection, the routes, and what to show when there is nothing to list — an empty collection is the
 * page's story to tell, in the page's words, and a component that rendered a sentence instead of a list would not be a
 * list.
 *
 * What this owns is the pairing that pages kept getting wrong by hand: a router-typed link rendered as the themed
 * anchor rather than the browser's default blue one, inside a real list item.
 */
