...
/**
 * With a ruleset chosen, each tile marks its membership against that one rather than listing all of them — the reason
 * this takes a slug rather than deriving it.
 */
...
/**
 * A single entry still lays out as a grid cell rather than stretching, which is what keeps a one-result search looking
 * like the same list.
 */
