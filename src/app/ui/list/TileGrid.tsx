 ...
 *
 * A List.
 * Callers hand it the tiles;
 * this owns only the rhythm between them: one track size, one gap, one distribution, shared by every surface that answers "which of these do you want to open" with pictures.
