 ...
 * 
 * Callers own the collection count and mutation details; this component owns the repeated standalone action treatment and accessible add/remove semantics.
 */
