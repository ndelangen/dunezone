 ...
 * 
 * The level follows depth. `order` keeps the document outline honest; `size` keeps a heading inside something else from shouting over the thing that contains it.
 */
