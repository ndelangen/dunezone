...
/**
 * The heading a titled block renders for itself. Internal to the blocks — not a component a page picks, which is the
 * whole point: a heading is a property of the region it names, so nothing can place one on its own or guess its level.
 *
 * The level follows depth. `order` keeps the document outline honest; `size` keeps a heading inside something else from
 * shouting over the thing that contains it.
 */
