...
/**
 * Binds a faction to the generic spotlight row: its token as the artwork, its detail route as the destination. Only the
 * faction-shaped knowledge lives here; the row itself is shared.
 */
