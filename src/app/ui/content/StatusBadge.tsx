 ...
 *
 * Callers own the mapping from their own status union to a tone; this component owns the mapping from tone to colour,
 * so "pending" is the same yellow whether it describes a membership request or an asset publication, and no page
 * re-invents that ladder inline.
 */
