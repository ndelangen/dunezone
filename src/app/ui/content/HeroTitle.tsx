 ...
 * 
 * Callers own the words and their alignment; this component owns the one white, shadowed, fluid-size display treatment every band title shares — the faction shields' Desdemona face, set in uppercase like the shields set it.
