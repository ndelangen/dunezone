...
export interface SurfaceProps {
  ...
  /**
   * Names the pane for assistive tech.
   * Required in practice whenever `as` is not `div`: an unnamed `section` or `aside` is not exposed as a landmark at all, so the semantic element buys the tag and none of the meaning.
   * Use
