...
/**
 * Whether a fresh measurement says anything new. Observers fire on every frame of a resize, and most of those frames
 * land on the same rounded pixels — keeping the old object keeps the surface from re-rendering for a measurement that
 * did not move.
 */
