 ...
 * This component owns what makes it one offer rather than a box of text: the whole surface is the target, the artwork identifies the subject before the words are read;
 * the chevron says where it goes, and the title truncates rather than reflowing.
 *
