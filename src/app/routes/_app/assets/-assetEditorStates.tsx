 ...
 *
 * The field itself is `AssetNameInput`, a Picker and the taxonomy's one fetching control, so no route holds a second page subscription and no widget fetches.
