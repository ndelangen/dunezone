...
export type DraftVariant = 'drafting' | 'swapping' | 'tokens' | 'setup-stack' | 'setup-sections' | 'setup-focus';
export const DRAFT_VARIANTS: readonly DraftVariant[] = ['drafting', 'swapping', 'setup-stack', 'setup-sections', 'setup-focus', 'tokens'];
