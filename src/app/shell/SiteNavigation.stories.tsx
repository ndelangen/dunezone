...
/**
 * The More panel, opened. It renders through a portal outside the canvas — the band hosting the nav is `overflow:
 * hidden`, so an in-place panel would clip at compact band heights.
 */
