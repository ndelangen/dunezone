 ...
 * Keeping the band and the frame in one file keeps both halves of that contract in one place; the band element then stays mounted across navigations, so a height change animates instead of cutting.
 * 
