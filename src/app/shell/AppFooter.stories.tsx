...
/**
 * A reduced-motion visit, pinned through the Motion toolbar global: the ambient-motion switch sits off. In the Default
 * story the switch is live and actually writes the `motion` cookie.
 */
