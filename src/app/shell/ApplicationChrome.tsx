 ...
 * The provider wraps the chrome too — the shell's markup stays plain CSS-module styling, but its components (the footer's tooltips) reuse the same Mantine primitives as page content. `colorScheme.ts` owns the scheme; the provider only relays the resolved verdict, so
