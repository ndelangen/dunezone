...
/**
 * Editor-domain drag behavior without owning the surrounding Mantine presentation. Each collection
 * composes its own Paper, actions, and accessible handle directly.
 */
