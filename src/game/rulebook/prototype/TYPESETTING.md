# Earlier typesetting experiment

This records the first experiment. The user's correction shifted the work to identifying page layouts, editable blocks and selectable book designs. The current study is described in [README.md](./README.md) and [PATTERNS.md](./PATTERNS.md). The continuation work suggested below is outside the current request.
