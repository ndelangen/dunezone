...
| Layout | Arrangement and purpose | Supported Sizes |
| --- | --- | --- |
| Single column | One full-width region for a sequence of Blocks, including rules, examples and repeated faction panels. | Square, A4, Tall. |
