...
/**
 * Canonical storage is intentionally wider than current authoring semantics: historical rows with a blank name must
 * remain readable while the UI requires a name for all new canonical writes.
 */
