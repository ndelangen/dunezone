 ...
 * Zod still owns semantic rules (parsed in handlers via the catalogue helpers); these derived validators give the wire the same structural contract instead of `v.any()`.
 */
