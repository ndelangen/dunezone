/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/publisher/wrangler.jsonc workers/publisher/worker-configuration.d.ts` (hash: eaf6ef3e9a40b86f400d5a81630b3ecb)
// Runtime types generated with workerd@1.20260811.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	ASSET_BUCKET: R2Bucket;
	USER_IMAGE_BUCKET: R2Bucket;
	PLAY_INGRESS_RATE_LIMIT: RateLimit;
	BROWSER: BrowserRun;
	...
	GAME_SERVICE: Fetcher /* dunezone-game */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "USER_IMAGE_PUBLIC_BASE_URL" | "CAPTURE_BASE_URL" | "CONVEX_EXECUTOR_BASE_URL" | "CONVEX_RENDER_URL" | "CONVEX_CLOUD_BASE_URL" | "GIT_SHA" | "WORK_WINDOW_MS" | "BROWSER_CAPTURE_TIMEOUT_MS" | "BROWSER_CLEANUP_GRACE_MS" | "PDF_MAX_BYTES" | "ASSET_PUBLISHER_EXECUTOR_SECRET">> {}
}
declare module "*.css" {
	const value: string;
