/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/game/wrangler.jsonc --env-interface=GameEnv workers/game/worker-configuration.d.ts` (hash: 84ec2189da1dd903cdcab1403844f019)
// Runtime types generated with workerd@1.20260811.1 2026-08-11 nodejs_compat
interface __BaseEnv_GameEnv {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	CONVEX_URL: "https://exuberant-finch-263.eu-west-1.convex.cloud";
	APPLICATION_ORIGIN: "https://dune.zone";
	GIT_SHA: "development";
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_GameEnv {}
}
interface GameEnv extends __BaseEnv_GameEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONVEX_URL" | "APPLICATION_ORIGIN" | "GIT_SHA">> {}
}
