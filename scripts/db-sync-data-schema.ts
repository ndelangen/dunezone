...
/**
 * Deep canonical form for schema equality: object keys sorted; array elements sorted by their own canonical JSON string
 * so `anyOf` / `oneOf` branch order does not matter (the old `array.map(normalize).sort()` compared `[object Object]`
