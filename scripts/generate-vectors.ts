 ...
 * Sources in media/ are kept pretty-printed (git-diffable), so this script rewrites them in place through a plugin-less pretty pass, so authoring dumps stay reviewable.
 *
