...
export default defineConfig({
  ...
  define: {
    /**
     * Never copy a developer or production deployment URL into the public catalogue. The global manual mock ignores
     * this inert value when app database modules load.
     */
