...
/**
 * Extension-scoped rather than bare globs: bare `src/**` pulled non-code files (local publisher dist output,
 * tsconfig.json) into the denominator. A new source extension (.js, .mts) must be added here to be counted.
 */
